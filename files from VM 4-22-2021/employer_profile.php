<?php
    session_start();
	$currentUserIDNum=$_SESSION['userID'];
    $conn4=mysqli_connect('localhost','root','p3rsonn3lp0rt4','users');
				$userPopulate = "SELECT firstName, lastName, username from accountCreation where id = '$currentUserIDNum'";
        ...
        <div class="row">
            <div class="col-lg-4 col-xl-4">
                <div class="card-box text-center">
                    ...
                    <h4 class="mb-0"><?php  echo $userInfoItems['firstName'];?></h4>
            ...
            <div class="col-lg-8 col-xl-8">
                    ...
                    <div class="container">
                        ...
                        <div class="tab-pane show active" id="about-me">
                            ...
                            <?php 
                                ...
                                $conn = OpenCon();
				$currentCompName =$userInfoItems['username'];
                                $sql = "SELECT company_name, position_title, locationInt, position_fieldID, listingID,  description from listing2 where company_name = '$currentCompName'";
				...
				<?php
					...
					$conn=OpenCon();
					$sqlQuery = "SELECT DISTINCT listingID FROM applications";
					...
					while( $idRecord = mysqli_fetch_assoc($listingIDSet)){
						...
						if ($currentLoopID == $currentID) {
							$applicantQuery = "SELECT DISTINCT applicantID from applications where listingID = '$currentID'";
