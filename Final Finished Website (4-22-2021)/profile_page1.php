...
<body>
<?php
$conn4=mysqli_connect('localhost','root','p3rsonn3lp0rt4','users');
				$userPopulate = "SELECT firstName, lastName, username from accountCreation where id = $userID";
				$userInfoPop = mysqli_query($conn4,$userPopulate) or die("database error:". mysqli_error($conn));
				$userInfoItems = mysqli_fetch_assoc($userInfoPop);
?>
   <div class="container">
        <div class="row">
            <div class="col-lg-4 col-xl-4">
                <div class="card-box text-center">
                    <img src="images/<?php echo $username;?>.png" src2="images/<?php echo $username;?>.jpg"  class="rounded-circle avatar-xl img-thumbnail" alt="profile-image">

                    <h4 class="mb-0"><?php  echo $userInfoItems['firstName'];?> <?php  echo $userInfoItems['lastName'];?></h4>
                    <p class="text-muted"><?php  echo $userInfoItems['username'];?></p>
                ...
                <div class="card-box">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="about-me">
                           ...
                           <!--  <iframe src="target_url.php"  style="width:710px; height:900px;"></iframe> -->
				<iframe src="https://docs.google.com/gview?url=https://personnelport.careers/resumes/<?php echo $username;?>.pdf&embedded=true" style="width:710px; height:900px;" frameborder="0"></iframe>
