...
<?php 
include 'almostComp/php/db_connection.php';
$conn = OpenCon();
...
<div class='mainbody'>
        ...
        <div id="listing_container">
		    ...
		    <br><?php echo "<ul>";
			foreach(preg_split("/((\r?\n)|(\r\n?))/", $record['additional_information']) as $line){
			echo "<li>$line</li>";
			}
			echo "</ul>";

			 ?>
                  <br><?php echo "<a href='../almostComp/php/listing-id.php?id={$record['listingID']}'>Click Here to Learn More</a>" ?>
                </p>
                </div>
            </div>
